    ...
    public class MailAttachment {
        ...
        public static void main(String[] args) {
           ...
           // nm.sendEmailCon("test", "zephain@gmail.com");
            nm.doSendMail("testing", "anuragtyagi009@gmail.com","Comtax Xml from GenericPortal","JHRKHDCTAX_Settlement_20140721.xml");
        ...
        public static String doSendMail(String mmsg, String toAddress,String subject,String filnme) throws Exception{
           String status="N";
          try {
              System.out.println("enter in mail process");
          ...
          msg.setText(messages);
              ...
              Multipart multipart = new MimeMultipart();
                 ...
                 //String filename = "C:/JHRKHDCTAX_Settlement_20140721.xml";
                  String filename = "/opt/comtax_files/genericpayxml/"+filnme.trim();
                  System.out.println("name in mail process"+filename);
