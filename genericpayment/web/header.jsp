...
<form  id="adminlogin" name="adminlogin" action="<%=ccph%>/GenericAdServlet" method="post">
...
<div class="modal-footer">
 <button class="btn btn-primary" type="button" onclick="encryptADMPassword('<%=rndadmin%>');">Login</button>
