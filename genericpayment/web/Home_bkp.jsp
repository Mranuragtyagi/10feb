...
String mssg=StringEscapeUtils.escapeHtml(request.getParameter("mssg")!=null?request.getParameter("mssg"):"" );
 String rnd=request.getSession().getAttribute("rnd").toString()!=null?(String)request.getSession().getAttribute("rnd").toString() :"";
...
<title>E generic Payment</title>
        ...
        <script type="text/javascript">
            function encryptDeptPassword(t){var p = document.LoginForm.password; if(p.value=="" || p.length==0){ document.LoginForm.password.value = ""; }else{document.LoginForm.password.value = m5(p.value, t);}}                
    </script> 
<style>
#signupForm label.error {color:red;}#LoginForm label.error{color:red;}#ForgotForm label.error{color:red;}</style>
...
placeholder="Secret Code" style="width:100px;"/>
      ...
      <div style="font-size: 13.9px; font-weight: bold; padding:2px; color:#900;" ><u>Important Security Notice:</u></div>
                     <div class="security">
                           
         					 <ol><li>URL address on the address bar of your internet browser begins with http://payonline.jharkhand.gov.in.</li>
        					<li>Do not enter login or other sensitive information in any pop up window.</li>
         					<li>You have verified the security certificate by clicking on the padlock icon of your internet browser.</li></ol>
 						   </div>
   ...
   <div class="span9">
      ...
      <br />
          <div class="span12">
             <div class="row-fluid">
              <div class="span6">
                <div id="netbankings">NET BANKING &amp; CARD PAYMENT </div>
                  ...
                  <li class="span6">
                     <div class="thumbnail">
                       <div id="Lcanvas" style="height:100%; width:100%;">
                         <div id="faq" style="pointer-events:none; padding-left:20px;">
						    ...
						    <label><span>*</span> Revenue will come earlier into the Government <br/>treasury as compared to old system. </label>
                         </div>
                    ...
                    <li class="span6">
                     <div class="thumbnail">
                      ...
                      <div id="faq" style="pointer-events:none; padding-left:20px;">
                         <p> Beware of Phishing attacks</p>
                         <label>Phishing is a fraudulent attempt, usually made through email, phone calls, SMS etc seeking your personal and confidential information.</label>
                         <label> Live Support call :- XXXXXXXXXX </label>
                         <label> Helpdesk Number :- XXXXXXXXXX </label>
                           <label>Mail-Id :- XXXXXXXX@XXXX.XXXX </label>
                           <label></label>
                       </div>
                      </div>
                    </div>
