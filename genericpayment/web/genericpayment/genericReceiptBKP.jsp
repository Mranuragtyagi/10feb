...
<%
 ...
 // vicclass.User user=request.getSession().getAttribute("user")!=null ? (vicclass.User)request.getSession().getAttribute("user") : null;
  ...
  String cin=StringEscapeUtils.escapeHtml(request.getParameter("er"));
  //String sql="select * from echallan_trans where CHALLAN_NO='"+id+"' " ;
 // String challan="0805201411372675" ;
  String sq="select  ifnull(REGISTERED,'N') as REGISTERED ,CHALLAN_STATUS from generic_epayment where CIN=? and status='0300' ";
  ...
  msg="please fill the correct CIN Number";
  if(rd==null)
  {
