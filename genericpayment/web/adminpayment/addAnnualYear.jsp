  ...
  <div class="row-fluid"> 
    ...
    <div id="content" class="span10">
      <ul class="breadcrumb">
        ...
        <li> <i class="icon-edit"></i> <a href="#">Add Financial Year</a> </li>
      </ul>
      <%if(msg!=null){%>
      ...
      <div class="row-fluid sortable">
        <div class="box span12">
          <div class="box-header" data-original-title>
            <h2><i class="fa fa-edit"></i><span class="break"></span>Add Financial Year</h2>
          </div>
          <div class="box-content">
              ...
              <table class="table table-bordered table-hover">
                <tr><th>
                  <input type="hidden" name="step" id="step" value="anualStep"><label>Add Financial Year</label>
                  <input type="text" name="anuyr" id="anuyr">(Ex: 2000-2001)</th></tr>
                  <tr><td>
...
<script>
		 ...
		 function fieldValidation(){
                var name=document.getElementById("anuyr").value;
         ...
         //   if((document.frm.department.value == '#')||(document.frm.department.value =="")||(!name.match(deptRegex))){
                ...
                alert("Please Enter the Appropriate Year");
                document.getElementById('anuyr').focus();
                return false;
            }else{
                document.frm.submit();
            }
