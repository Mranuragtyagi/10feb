...
<html lang="en">    
    <%
        if (request.getSession().getAttribute("user") == null) {
            ...
            String msdg = msgtmplte.getTempmsg();
            String emlmsg = msgtmplte.getTempmail();
    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
        <head>
            ...
            <link id="style_less" href="../assets/metro/css/hidediv.css" rel="stylesheet">
                    ...
                    <div id="content" class="span10">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                ...
                                <%if(msg!=null){%>
      <div class="alert alert-block" id="msgupld">
        <h4 class="alert-heading" id="mgsupload"><%=msg%></h4>
      </div>
      <%}%>
                                <div id="settingsuccessmsg" name="settingsuccessmsg" class="flash alert alert-success hideMe" style="display:none;"></div>
                                <div id="settingmsg" name="settingmsg" class="flash alert alert-error hideMe" style="display:none;"></div>
                            <div class="row-fluid sortable">
                                <div class="box span12">
                                    <div class="box-header" data-original-title>
                                        <h2><i class="icon-edit"></i><span class="break"></span>General Settings</h2>
                                </div>
                                <div class="box-content list-tab">
                                    ...
                                    <div class="tab-content span11">
                                        <div id="sectionA" class="row-fluid tab-pane fade in active">
                                            <form id="generalsetting" name="generalsetting" method="" action="" class="form-horizontal">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <th align="left" colspan="2"><br></br>
                                                                    <input type="button" class="btn btn-primary"  id="save" name="save" value="Upload" onclick="submitSetting('upload', '<%=ccp%>');" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                                                 
                                                                </th>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                ...
                                                <fieldset>                                
                                                    <table class="table table-bordered">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <th align="left" colspan="2"><br></br>                                            
                                                                    <input type="button" class="btn btn-primary"  id="save" name="save" value="<%= sbean.getSMS_ID() != 0 ? update : save%> " onclick="submitSetting('sms', '<%=ccp%>');" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                                ...
                                                <fieldset>  
                                                    ...
                                                    <table class="table table-bordered">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <th align="left" colspan="2"><br></br>
                                                                    <input type="button" class="btn btn-primary"  id="save" name="save" value="<%= bannerbean.getContent_id() != 0 ? update : save%> " onclick="submitSetting('banner', '<%=ccp%>');" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                                                    <input type="reset" class="btn btn-default"  id="reset" name="reset" value="Reset" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                                                    
                                                                </th>
                                                            </tr>
                                                        </tbody>
                                                ...
                                                <fieldset>        
                                                    ...
                                                    <table class="table table-bordered">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <th align="left" colspan="2"><br></br>
                                                                    <input type="button" class="btn btn-primary"  id="save" name="save" value="<%= gb.getGeneric_id() != 0 ? update : save%> " onclick="submitSetting('billdesk', '<%=ccp%>');" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                                                    <input type="reset" class="btn btn-default"  id="reset" name="reset" value="Reset" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                                                    
                                                                </th>
                                                            </tr>
                                                        </tbody>
                                                ...
                                                <fieldset>   
                                                    ...
                                                    <table class="table table-bordered">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <th align="left" colspan="2"><br></br>
                                                                    <input type="button" class="btn btn-primary"  id="save" name="save" value="<%= msgtmplte.getTempid() != "" ? update : save%> " onclick="submitSetting('mesages', '<%=ccp%>');" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                                                    <input type="reset" class="btn btn-default"  id="reset" name="reset" value="Reset" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                                                    
                                                                </th>
                                                            </tr>
                                                        </tbody>
                                                ...
                                                <fieldset>
                                                    ...
                                                    <table class="table table-bordered">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <th align="left" colspan="2"><br></br>
                                                                    <input type="button" class="btn btn-primary"  id="save" name="save" value="<%= mailbean.getEMAIL_ID() != 0 ? update : save%> " onclick="submitSetting('email', '<%=ccp%>');" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                                                    <input type="reset" class="btn btn-default"  id="reset" name="reset" value="Reset" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                                                    
                                                                </th>
                                                            </tr>
                                                        </tbody>
        ...
        <script type="text/javascript" src="<%=ccp%>/assets/metro/js/sitesetting.js"></script>
