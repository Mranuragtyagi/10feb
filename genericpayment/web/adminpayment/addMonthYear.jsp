  ...
  <div class="row-fluid"> 
    ...
    <div id="content" class="span10">
      <ul class="breadcrumb">
        ...
        <li> <i class="icon-edit"></i> <a href="#">Add Year</a> </li>
      </ul>
      <%if(msg!=null){%>
      ...
      <div class="row-fluid sortable">
        <div class="box span12">
          <div class="box-header" data-original-title>
            <h2><i class="fa fa-edit"></i><span class="break"></span>Add Year</h2>
          </div>
          <div class="box-content">
              ...
              <table class="table table-bordered table-hover">
                <tr>
                    <th>
                        <input type="hidden" name="step" id="step" value="mnthStep"><label>Monthly/Quarterly Year</label>
                        <input type="text" name="mnthyr" id="mnthyr">(Ex: 2000)
                    </th>
                </tr>
                  <tr><td>
...
<script>
		 ...
		 function fieldValidation(){
                var name=document.getElementById("mnthyr").value;
         ...
         //   if((document.frm.department.value == '#')||(document.frm.department.value =="")||(!name.match(deptRegex))){
                ...
                document.getElementById('mnthyr').focus();
                return false;
            }else{
                document.frm.submit();
            }
