...
<img src="images/watchnow.png"  /><br /> 
              ...
              <div class="span10 uproundbox banner">
                <div class="span8 text">
                  ...
                  <div id="cards" class="span12 fc_FFF"> </div>
                </div>
                ...
                <div class="span3 roundbox signup-form pull-right" align="center">
                  ...
                  <form accept-charset="UTF-8" id="signupForm" action="genericpayment/remainingUnregisteredDetails.jsp" method="post">
              ...
              <div class="span10 slogan">
                <div style="background-color: #FC0; margin-top:-10px;"> 
                  ...
                  <h2><%=utility.SystemGlobals.getContent1()%></h2>
                  <!--<h3>Government of Jharkhand Electronic Revenue Receipt Portal</h3>-->
                  <h3><%=utility.SystemGlobals.getContent2()%></h3>
                </div>
	...
	<jsp:param name="copyright" value="Copyright@ 2014 Jharkhand Government Incorporated.All rights reserved" />
        <jsp:param name="terms" value="Terms of Use&nbsp;|&nbsp;Privacy Policy&nbsp;|&nbsp;Disclaimer&nbsp;|&nbsp;Feedback&nbsp;|&nbsp;Sitemap |&nbsp;FAQs |&nbsp;" />
        <jsp:param name="contact" value="Contact us- jhrpayonline@gmail.com" />
        <jsp:param name="version" value="Version - 0.83 Release Date - 20-Oct-2014" />
</jsp:include>
              </div>
            </div>
            <!--div class="span12 roundthumb">
