...
<html>
  ...
  <%
   String ccp="http://"+ request.getHeader("HOST")+request.getContextPath()+"";
    ...
    String mssg=SystemGlobals.getMerchant_id()+"|"+ch.getCHALLAN_NO()+"|NA|"+ch.getAMOUNT()+"|NA|NA|NA|INR|NA|R|"+SystemGlobals.getSecurity_id()+"|NA|NA|F|"+ch.getTREASURY_CODE()+"|NA|NA|NA|NA|NA|NA|"+ccp+"/genericpayment/genericResponse.jsp|"+secrets+"";
     
    
    String hash=GenericBean.checkSumSHA256(mssg);
    mssg=SystemGlobals.getMerchant_id()+"|"+ch.getCHALLAN_NO()+"|NA|"+ch.getAMOUNT()+"|NA|NA|NA|INR|NA|R|"+SystemGlobals.getSecurity_id()+"|NA|NA|F|"+ch.getTREASURY_CODE()+"|NA|NA|NA|NA|NA|NA|"+ccp+"/genericpayment/genericResponse.jsp|"+hash+""; 
