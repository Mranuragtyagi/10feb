    ...
    <div class="container-fluid-full">
        ...
        <%@ include file="../assets/metro/__inc/main_menu.jsp"%>
			...
			<i class="icon-angle-right"></i> 
                    ...
                    <li>
                        <i class="icon-edit"></i>
			<a href="#">List ID Proof</a>
                    </li>
                </ul>
                <div class="row-fluid sortable">
                    <div class="box span12" >
                        <div class="box-header" data-original-title>
                            <h2><i class="icon edit"></i><span class="break"></span>List ID Proof</h2>
                        </div>
                        <div class="box-content">
                            <table id="printview" class="display">
                                ...
                                <tbody>
                                  <% 
                                     String sql="select generic_idproof.STATUS,initcap(IDPROOF) as IDPROOF, initcap(generic_dept.dept_name)  as dname from generic_idproof join  generic_dept on generic_dept.dept_id=generic_idproof.department order by generic_dept.dept_name " ;
