    ...
    <input type="hidden" name="ccp" id="ccp" value="<%=ccpf%>" />
        <div class="span12 roundbox " id="footer">
              ...
              <div class="span3 roundbox"><div class="fb-like-box" data-href="https://www.facebook.com/payonlinejharkhand" data-width="240" data-colorscheme="light" data-show-faces="true" data-header="false" data-stream="false" data-show-border="false"></div>
               ...
               <div class="span6"><%=utility.SystemGlobals.getCopyright()!=null?utility.SystemGlobals.getCopyright() : "Not Set"%><!--Copyright@ 2014 Jharkhand Government Incorporated.All rights reserved--></div>
               <div class="span6 pullright"><%=utility.SystemGlobals.getTerms()!=null?utility.SystemGlobals.getTerms():"Not Set"%><!--Terms of Use&nbsp;|&nbsp;Privacy Policy&nbsp;|&nbsp;Disclaimer&nbsp;|&nbsp;Feedback&nbsp;|&nbsp;Sitemap |&nbsp;FAQs |&nbsp;--><a href="<%=ccpf%>/assets/PayonlineHelp.pdf" target="_blank"> Help </a></div>
               </div>
               <div class="span12 fc_000">
               <div class="span4"><%=utility.SystemGlobals.getContactus()!=null?utility.SystemGlobals.getContactus():"Not Set"%><!--Contact us- jhrpayonline@gmail.com--></div>
              <div class="span4"><%=utility.SystemGlobals.getVersion()!=null?utility.SystemGlobals.getVersion():"Not Set"%><!--Version - 0.83 Release Date - 20-Oct-2014--></div>
